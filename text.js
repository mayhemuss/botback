import {BOT_NAME, web_app_url} from "./tokens/url.js";
...
export const texts = {
  ...
  stillNeedSubscribe: 'Все-таки необходимо подписаться на канал\n' +
    '\n' +
    'https://t.me/games_skynet',
  helloText: "Добро пожаловать в BOT регистрации на кибер-турниры от SkyNet GAMES. " +
  ...
  AwaitText: "Добро пожаловать в BOT регистрации на кибер-турниры от SkyNet GAMES. " +
    "Сейчас мы готовим анонсы новых мероприятий, ожидайте новостей на канале https://t.me/games_skynet",
  allBad: 'что то пошло не так',
  userReg: "Что бы зарегистрироваться как член команды, " +
    "капитан комманды должен прислать вам реферальную сыллку, " +
    "перейдя по ней появится возможность зарегистрироваться как участник как его команды",
  ...
  capitanRegDone: (name, commandName, memberCount) => {
    return `Спасибо за регистрацию, ${name}. Сейчас как капитану команды ${commandName
    } вам придет сообщение с реферальной ссылкой для оставшихся ${memberCount - 1
    } членов вашей команды, не потеряйте его 👇👇👇`
  },
...
export const gameVariantsText = {
  ...
  swear_words: ["жопа", "хуй", "гавно", "пидор", "гандон", "ебан", "ёба", "шалав", "залуп"]
}
